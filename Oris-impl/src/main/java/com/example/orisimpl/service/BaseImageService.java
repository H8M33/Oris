...
//    public boolean isAuthor(UUID imageId, UUID userId){
//        return imageRepository.findById(imageId).orElseThrow(() -> new ImageNotFoundException(imageId)).getAuthor().getId().equals(userId);
//    }
